...
if not exist "evidencias\resultados\100" mkdir "evidencias\resultados\100"
if not exist "evidencias\reportes\100" mkdir "evidencias\reportes\100"
if not exist "temp" mkdir "temp"

rem Rutas de archivos
set TEST_PLAN=test_plan.jmx
set RESULTADOS=evidencias\resultados\100\resultados_100.jtl
set REPORTES=evidencias\reportes\100\reportes_100
...
rem Ejecutar el script Python para activar el escenario de 100 TPS
py generacion_reporte/add_100.py
